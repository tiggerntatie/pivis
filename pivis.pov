...
#declare ShowRing = 1;
#declare ShowBox = 1;
#declare ShowBoxFloor = 1;
#declare ViewClose = 1;
#declare ViewMedium = 0;
#declare ViewFar = 0;
...
box {
    ...
    texture {
        ...
        normal { crackle 0.2 turbulence 0.25 scale 0.02}
...
object {
  Wall(color rgb <0.560784,0.56784,0.737255>)
  rotate <0,90,0>
  translate <-RoomWidth/2,0,0>
}
object {
  Wall(color rgb <0.737255,0.560784,0.56784>)
  translate <0,0,-RoomWidth/2>
}
...
#if (ViewMedium)
    location <-1, 1.5, -7>
    look_at <0.1, 0.1, -RingDiameter/2>
#end // if ViewMedium
...
#if (UseBlur)
  focal_point < .11, 0.13, -RingDiameter/2>    //
  aperture 0.02    // 
  variance 0
  blur_samples 100
#end
